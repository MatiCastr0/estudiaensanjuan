...
function mostrarResultados(resultados) {
  ...
  resultados.forEach((carrera) => {
    ...
    <div class="card-body">
        ...
        <p class="card-text"><small class="text-muted"><img src="${carrera.logo}" alt="${carrera.universidad}" style="height: 3em;"> ${carrera.universidad}</small></p>
    ...
    carreras.forEach((carrera) => {
      ...
      elemento.innerHTML = `
            ...
            <div class="card-body">
                <h5 class="card-title">${carrera.nombre}</h5>
                <p class="card-text">${carrera.descripcion}</p>
                <p class="card-text"><small class="text-muted"><img src="${carrera.logo}" alt="${carrera.universidad}" style="height: 3em;"> ${carrera.universidad}</small></p>                <a href="${carrera.enlace}" class="btn btn-primary" target="_blank">Ver más</a>
              </div>
            </div>
